...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    void addNote(Note note) {
        ...
        values.put(KEY_ID, note.id); // Contact Name
        values.put(KEY_NAME, note.title); // Contact Name
        values.put(KEY_CONTENT, note.content); // Contact Phone
    ...
    Note getNote(int id) {
        ...
        Note note = new Note(cursor.getString(1), cursor.getString(2),Integer.parseInt(cursor.getString(0)));
        // return contact
        return note;
    }
    ...
    public int updateNote(Note note) {
        ...
        ContentValues values = new ContentValues();
        values.put(KEY_NAME, note.title);
